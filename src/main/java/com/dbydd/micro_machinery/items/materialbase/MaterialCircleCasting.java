...
public class MaterialCircleCasting extends Item implements IHasModel {

	public MaterialCircleCasting(String material) {
		String itemname = "CircleCasting" + material;
