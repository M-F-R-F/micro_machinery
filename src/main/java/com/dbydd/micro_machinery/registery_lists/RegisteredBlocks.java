...
public class RegisteredBlocks {
    ...
    public static final Block PIGIRON_ANVIL = new BlockAnvil(Block.Properties.create(Material.IRON).notSolid().hardnessAndResistance(4.0f), "pigiron_anvil", EnumAnvilType.PIGIRON);
    //cable
