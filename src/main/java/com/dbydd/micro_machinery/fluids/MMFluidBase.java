...
public class MMFluidBase {
    ...
    public MMFluidBase(String name, Block.Properties fluid_block_properties, BiFunction<FluidAttributes.Builder, Fluid, FluidAttributes> factory) {
        ...
        this.fluid_block = BLOCK_REGISTER.register(name, () -> new FlowingFluidBlock(this.fluid::get, fluid_block_properties));
        this.fluid_bucket = ITEM_REGISTER.register(name + "_bucket", () -> new BucketItem(this.fluid::get, MMItemBase.DEFAULT_PROPERTIES));
        this.fluid_properties = new ForgeFlowingFluid.Properties(this.fluid, this.fluid_flowing, factory.apply(FluidAttributes.builder(fluid_resource_location, fluid_flow_resource_location), this.fluid.get()));
