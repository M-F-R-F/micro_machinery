...
public class ModRecipes {
    ...
    public static final KlinRecipe test = new KlinRecipe(new FluidStack(ModFluids.MOLTEN_COPPER, 144), new ItemStack(Items.APPLE, 1), new ItemStack(ModBlocks.ORECOPPER, 1), 12);
}
