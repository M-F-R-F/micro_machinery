...
public class ModGenerators {
    ...
    public static final OreGenRecipe copper1 = new OreGenRecipe(ModBlocks.ORECOPPER, new Block[]{Blocks.STONE}, 0, 8, 48, 6, 8);
    //public static final OreGenRecipe copper2 = new OreGenRecipe(ModBlocks.ORECOPPER, new Block[]{Blocks.STONE, 5}, 0, 0, 255, 8, 3);
