...
public class ModGenerators {
    ...
    public static final OreGenRecipe copper1 = new OreGenRecipe(ModBlocks.ORECOPPER.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState()}, 0, 8, 48, 6, 8, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    ...
    public static final OreGenRecipe tin1 = new OreGenRecipe(ModBlocks.ORETIN.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState()}, 0, 16, 56, 8, 4, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    public static final OreGenRecipe tin2 = new OreGenRecipe(ModBlocks.ORETIN.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState().withProperty(BlockStone.VARIANT, BlockStone.EnumType.ANDESITE)}, 0, 0, 255, 16, 2, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    public static final OreGenRecipe silver1 = new OreGenRecipe(ModBlocks.ORESILVER.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState()}, 0, 2, 32, 4, 4, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    ...
    public static final OreGenRecipe nickel1 = new OreGenRecipe(ModBlocks.ORENICKEL.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState()}, 0, 2, 48, 4, 4, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    ...
    public static final OreGenRecipe pyrolusite = new OreGenRecipe(ModBlocks.OREPYROLUSITE.getDefaultState(), new IBlockState[]{Blocks.SANDSTONE.getDefaultState(), Blocks.RED_SANDSTONE.getDefaultState()}, 0, 30, 255, 4, 3, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    ...
    public static final OreGenRecipe chromite1 = new OreGenRecipe(ModBlocks.ORECHROMITE.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState()}, 0, 4, 20, 4, 4, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    ...
    public static final OreGenRecipe ilmenite1 = new OreGenRecipe(ModBlocks.OREILMENITE.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState()}, 0, 0, 16, 2, 3, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    ...
    public static final OreGenRecipe bauxite = new OreGenRecipe(ModBlocks.OREBAUXITE.getDefaultState(), new IBlockState[]{Blocks.GRAVEL.getDefaultState(), Blocks.DIRT.getDefaultState()}, 0, 70, 56, 2, 4, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
    public static final OreGenRecipe nolanite = new OreGenRecipe(ModBlocks.ORENOLANITE.getDefaultState(), new IBlockState[]{Blocks.STONE.getDefaultState()}, 0, 0, 255, 2, 4, false, 0, 0, 0, OreGenEvent.GenerateMinable.EventType.CUSTOM);
