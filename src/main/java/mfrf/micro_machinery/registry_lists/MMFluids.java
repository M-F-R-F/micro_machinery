...
//    public static final Optional<DeferredRegister<FluidType>> FLUID_TYPE_REGISTER = Optional.of(DeferredRegister.create(ForgeRegistries.FLUID_TYPES.get(), MicroMachinery.MODID));
