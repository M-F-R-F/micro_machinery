...
public class MMBlocks {
    ...
    KLIN = makeBlockWithItem("klin", () -> new BlockKlin(Block.Properties.of().sound(SoundType.METAL).noOcclusion().requiresCorrectToolForDrops().strength(2.0f))),
            ...
            ANVIL_STONE = makeBlockWithItem("anvil_stone", () -> new BlockAnvil(Block.Properties.of().sound(SoundType.ANVIL).noOcclusion().strength(2.0f).requiresCorrectToolForDrops(), EnumAnvilType.STONE, 16)),
            ANVIL_BRONZE = makeBlockWithItem("anvil_bronze", () -> new BlockAnvil(Block.Properties.of().sound(SoundType.ANVIL).noOcclusion().strength(3.0f).requiresCorrectToolForDrops(), EnumAnvilType.BRONZE, 16)),
