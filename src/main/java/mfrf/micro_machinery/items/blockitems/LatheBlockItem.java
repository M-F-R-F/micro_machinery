...
public class LatheBlockItem extends BlockItem {
    ...
    public LatheBlockItem() {
        super(RegisteredBlocks.LATHE, new Item.Properties().group(MicroMachinery.MMTAB));
    }

    @Override
    protected boolean canPlace(BlockItemUseContext p_195944_1_, BlockState p_195944_2_) {
        boolean b = super.canPlace(p_195944_1_, p_195944_2_);
        BlockState blockState = p_195944_1_.getWorld().getBlockState(p_195944_1_.getPos().m_142300_(p_195944_1_.getPlacementHorizontalFacing().rotateY()));
