...
import mfrf.micro_machinery.blocks.machines.multi_block_old_system.multi_block_main_parts.huge_container.TileHugeContainer;
import mfrf.micro_machinery.blocks.machines.multi_block_old_system.multiblock_component.energy_interface.TileEnergyInterface;
import mfrf.micro_machinery.blocks.machines.multi_block_old_system.pump.TilePump;
...
public class RegisteredBlockEntityTypes {
    public static DeferredRegister<BlockEntityType<?>> TILE_ENTITY_TYPE_REGISTER = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, MicroMachinery.MODID);
