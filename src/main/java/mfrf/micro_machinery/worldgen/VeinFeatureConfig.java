...
public class VeinFeatureConfig implements FeatureConfiguration {
    ...
    public VeinFeatureConfig(Map<Double, OreConfiguration.TargetBlockState> blocks, Double veinGenChance, Double generateChancePerOre, int range, int oreStratum, int oreDepositHeight, int stoneHeight, int minHeight, int maxHeight, RuleTest predicate) {
        this.blocks = blocks;
