...
public class RegisteredTileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<TileRedstoneInterface>> REDSTONE_INTERFACE = TILE_ENTITY_TYPE_REGISTER.register("part", () -> TileEntityType.Builder.create(TileRedstoneInterface::new, RegisteredBlocks.REDSTONE_INTERFACE).build(null));
}