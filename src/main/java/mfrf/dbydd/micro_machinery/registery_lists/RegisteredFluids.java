...
public class RegisteredFluids {
    ...
    public static final MMFluidBase MOLTEN_HSS = new MMFluidBase("molten_hss", Block.Properties.create(Material.LAVA).lightValue(15), (fluid) -> fluid.temperature(1793),20);
